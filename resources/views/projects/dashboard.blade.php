@extends('layouts.master') @section('title', 'Dashboard') @endsection @section('custom-css')
                ...
                <div class="well well-sm makeup">
                    <div class="row">
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" id="menu1" data-toggle="dropdown" data-target="#myModal"><span class="glyphicon glyphicon-folder-open"></span> Skills<span class="caret"></span></button>
            ...
            <div class="modal-body">
                <form role="form-group" method="post" action="{{ route('projects.store') }}" onsubmit="showLoader()">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Pibbble" required> @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="technologies" class="form-control" id="technologies" placeholder="PHP, JavaScript, HTML, Firebase." required> @if ($errors->has('technologies'))
                        <span class="help-block">{{ $errors->first('technologies') }}</span> @endif
                    </div>
                    <div class="form-group">
                        <label for="upload"><span class="glyphicon glyphicon-upload"></span> Upload</label>
                        <input type="text" name="url" class="form-control" id="upload" placeholder="http://www.pibbble.com" required> @if ($errors->has('url'))
